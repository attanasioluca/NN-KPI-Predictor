...
def main():
    ...
    joblib.dump(x_scaler, 'LR_model/output/lr_x_scaler.pkl')
    joblib.dump(y_scaler, 'LR_model/output/lr_y_scaler.pkl')
    ...
    # Save the model
    joblib.dump(model, 'LR_model/output/lr_model.pkl')
